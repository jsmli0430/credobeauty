...
if page == "Overview Metrics":
    ...
    for _, row in filtered_df.iterrows():
        ...
        sentiment_display = f"<p><strong>Sentiment:</strong> {sentiment}</p>" if sentiment else "na"
        review_display = f"<p><strong>Review:</strong> {first_sentence}</p>" if first_sentence else "na"
